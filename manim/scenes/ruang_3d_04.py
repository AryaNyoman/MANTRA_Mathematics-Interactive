...
class DuaKaliPythagoras(AdeganMatra):
    def construct(self):
        ...
        p1 = rumus(r"AC^2 = 6^2 + 6^2 = 72", 32, AKSEN2).to_corner(UR, buff=0.5)
        ...
        with sinema.babak(self, "hitung1", DURASI) as b:
            ...
            b.jeda(0.8)
        qc.periksa_adegan(self, {"panel 1": p1, "nilai AC": n_ac, "identitas": jati},
                          [("panel 1", "identitas")])
        ...
        qc.periksa_adegan(self, {"AG": ag, "CG": cg, "nilai CG": n_cg, "panel 1": p1,
                                 "identitas": jati},
                          [("nilai CG", "nilai AC")] if False else [("panel 1", "identitas")])

        # --- Babak 5: Pythagoras kedua, memakai hasil pertama sebagai sisi.
        p2 = rumus(r"AG^2 = 72 + 36 = 108", 32, AKSEN)
        p2.next_to(p1, DOWN, buff=0.3).align_to(p1, RIGHT)
        p3 = rumus(r"AG = 6\sqrt{3} \approx 10{,}392", 32, AKSEN)
        ...
        with sinema.babak(self, "tutup", DURASI) as b:
            ...
            b.jeda(1.2)
        qc.periksa_adegan(self, {"AG": ag, "panel 3": p3, "alasan": alasan,
                                 "identitas": jati},
                          [("panel 3", "identitas"), ("alasan", "identitas")])
