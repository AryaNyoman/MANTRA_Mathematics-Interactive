    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Coba parabola tidur. Bentuknya mirip parabola biasa yang direbahkan, dan ia juga gagal',
          'Terakhir grafik tangga. Ia lolos, walaupun garisnya putus-putus dan terlihat aneh',
        ],
      },
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Sekarang perhatikan baik-baik: saat h Anda besarkan, ke arah mana parabolanya pergi?',
          'Terakhir geser a sampai melewati nol. Perhatikan parabolanya berbalik arah',
        ],
      },
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Ubah nilai c sampai D berubah tanda. Perhatikan titik potongnya menghilang',
          'Cari nilai c yang membuat D tepat nol. Parabolanya akan menyentuh sumbu x di satu titik saja',
        ],
      },
    ],
    seringKeliru: {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Coba buat parabola yang tidak memotong sumbu x sama sekali. Perhatikan bentuk faktornya menghilang, dan bacalah keterangannya',
          'Coba tempatkan titik kedua tepat di atas puncak. Alatnya akan menolak, dan itu memang benar',
        ],
      },
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Bandingkan: bentuknya berbeda, tetapi perpindahannya persis sama',
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Bandingkan kedua hasilnya. Di sebelah kanan sumbu y keduanya sama, di sebelah kiri keduanya berbeda',
          'Ganti fungsi dasarnya dan ulangi. Aturannya tetap sama',
        ],
      },
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Ubah pengalinya menjadi kurang dari 1, dan lihat kurvanya berbalik menjadi peluruhan',
        ],
      },
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Ubah bilangan pokoknya. Kedua kurva berubah bersamaan, karena keduanya memang satu pasangan',
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Perhatikan bahwa kurvanya DIPUTUS di asimtot, tidak disambung menyeberang. Menyambungnya akan menggambar garis yang sebenarnya tidak ada',
          'Baca tabel angkanya. Nilainya makin dekat ke asimtot, tetapi tidak pernah sama dengannya',
        ],
      },
    ],
    seringKeliru: {
