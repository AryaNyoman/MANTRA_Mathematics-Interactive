...
export const TAHAP_NYATA: TahapStatistika[] = [
  {
    ...
    penjelasan: [
      { jenis: 'paragraf', teks: 'Tiga belas materi sebelumnya membangun alat: cara menyajikan data, cara meringkasnya jadi satu dua angka, dan cara membaca hubungan dua data. Materi ini tidak menambah alat. Materi ini memperlihatkan enam tempat di luar kelas tempat alat-alat itu bekerja, dan pertanyaan apa yang harus dibawa ke sana.' },
      { jenis: 'sorot', teks: 'Semua angka di materi ini angka contoh, dibuat mirip kenyataan supaya cara membacanya terasa nyata. Yang perlu dibawa pulang bukan angkanya, tetapi pertanyaannya.' },

      { jenis: 'sesi', judul: 'Nilai rapor satu kelas' },
      { jenis: 'paragraf', teks: 'Wali kelas melaporkan rata-rata ulangan kelasnya 7,35. Terdengar bagus. Histogramnya menunjukkan hal lain: dari dua puluh siswa, sebelas mendapat 6, tiga mendapat 7, dan enam mendapat 10. Enam siswa di angka 10 itulah yang mengangkat rata-ratanya. Median kelas ini 6, karena siswa ke-10 dan ke-11 dari bawah sama-sama di angka 6.' },
      ...
      { jenis: 'paragraf', teks: 'Yang bekerja di sini adalah penyajian data dari Materi 02 dan modus dari Materi 05: bulan terbasah adalah bulan yang paling sering hujan lebat. Rata-rata setahun malah kurang berguna, karena yang penting bukan berapa hujan setahun, tetapi kapan hujan itu datang.' },
      ...
      { jenis: 'paragraf', teks: 'Pelatih yang butuh kepastian memilih pemain A, yang simpangan bakunya kecil. Pelatih yang sedang tertinggal jauh dan butuh keajaiban mungkin memilih pemain B. Simpangan baku dari Materi 08 bukan cuma rumus: simpangan baku mengukur "bisa diandalkan atau tidak", dan itu pertanyaan yang dijawab pelatih, dokter, dan pabrik setiap hari.' },
      ...
      { jenis: 'paragraf', teks: 'Iklan memperlihatkan batang penjualan yang melonjak tinggi. Lihat sumbu-y: mulai dari 480, bukan dari 0. Kenaikan dari 486 ke 512 memang ada, sekitar 5 persen, tetapi gambarnya berteriak "berlipat ganda". Angka yang sama, digambar dari nol, hampir rata.' },
      { jenis: 'paragraf', teks: 'Ini Materi 13 yang muncul setiap hari di layar HP: grafik dengan data benar tetap bisa memberi kesan keliru. Pertanyaan pertamanya selalu sama. Sumbunya mulai dari berapa, dan apakah itu diberitahukan?' },
      ...
      { jenis: 'paragraf', teks: 'Diagram pencar dari Materi 10 dan koefisien korelasi dari Materi 12 memberi tahu seberapa rapat dua data bergerak bersama. Untuk mengklaim sebab, perlu percobaan yang mengendalikan hal lain, dan itu urusan penelitian, bukan cuma gambar.' },
      ...
      { jenis: 'sorot', teks: 'Angka tidak pernah berbicara sendiri. Yang berbicara adalah pilihan: apa yang diukur, siapa yang diukur, dan cara menampilkannya.' },
      {
        ...
        butir: [
          ...
          'Sumbunya mulai dari berapa, dan apa yang tidak ikut ditampilkan? Grafik yang benar angkanya tetap bisa dibuat memberi kesan keliru.',
        ],
      },
      { jenis: 'paragraf', teks: 'Keenam contoh di atas dijawab dengan alat yang sudah ada di tangan. Yang membedakan pembaca yang baik bukan rumus tambahan, tetapi kebiasaan berhenti sebentar dan bertanya sebelum percaya.' },
    ],
    seringKeliru: {
