...
export const TAHAP_HUBUNGAN: TahapStatistika[] = [
  /* ================================================================= */
  {
    ...
    seringKeliru: {
      ...
      isi: 'Kesalahan ini gampang terjadi saat memindahkan angka dari tabel ke gambar, apalagi kalau tabelnya tersusun mendatar. Akibatnya pola datanya rusak, dan kesimpulan yang diambil ikut salah tanpa ada tanda peringatan apa pun. Periksa ulang satu titik saja sebagai contoh sebelum melanjutkan: siswa yang belajar 2 jam bernilai 55, jadi titiknya harus berada di 2 pada sumbu mendatar dan 55 pada sumbu tegak.',
    ...
    penjelasan: [
      ...
      { jenis: 'paragraf', teks: 'Mencari garis terkecil itu dengan coba-coba tidak praktis. Untungnya ada rumus yang langsung memberikan jawabannya.' },
      {
        ...
        baris: [
          ...
          '',
          'b = (n x 4814 - 65 x 700) : (n x 505 - 65²)',
          '  = (48140 - 45500) : (5050 - 4225)',
          '  = 2640 : 825',
          '  = 3,2',
          '',
          'a = rata-rata y - b x rata-rata x',
          '  = 70 - 3,2 x 6,5',
          '  = 49,2',
        ],
      ...
      { jenis: 'sesi', judul: 'Interpolasi aman, ekstrapolasi berbahaya' },
      {
        ...
        baris: [
          ...
          '  ramalan = 49,2 + 3,2 x 7 = 71,6      masuk akal',
          '',
          'x = 40 jam  (jauh di luar rentang data)',
          '  ramalan = 49,2 + 3,2 x 40 = 177,2    mustahil, nilai tertinggi 100',
        ],
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
      ...
      { jenis: 'paragraf', teks: 'Kuadratkan r, dan hasilnya punya arti yang lebih gampang dipakai. Pada data kita r kuadrat sama dengan 0,97, artinya sekitar 97 persen keragaman nilai bisa dijelaskan oleh garis yang memakai lama belajar.' },
      ...
      { jenis: 'paragraf', teks: 'Ada jebakan besar pada r, dan jebakan ini gampang dilupakan: r hanya mengukur kelurusan. Kalau hubungannya melengkung, r bisa nol padahal hubungannya justru sempurna.' },
      {
        jenis: 'contoh',
...

      {
        ...
        langkah: [
          ...
          'Buka contoh melengkung, lalu perhatikan r nya nol padahal polanya jelas sekali.',
