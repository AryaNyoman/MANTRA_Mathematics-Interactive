    ...
    penjelasan: [
      ...
      { jenis: 'paragraf', teks: 'Median hanya memakai POSISI. Bagi median, gaji direktur itu cuma "satu data yang ada di paling kanan". Mau 75 juta atau 750 juta, posisinya tetap sama, dan mediannya tidak berubah sedikit pun.' },
      {
        ...
        langkah: [
          ...
          'Perhatikan penanda mean dan penanda median. Mana yang ikut lari, mana yang berhenti di tempat?',
          'Perhatikan selisih mean dan median. Apa yang terjadi padanya saat titik itu makin jauh?',
          'Kalau Anda hanya diberi tahu bahwa mean jauh lebih besar daripada median, apa yang bisa Anda tebak tentang bentuk datanya?',
        ],
      },
    ...
    penjelasan: [
      ...
      { jenis: 'sesi', judul: 'Menemukan ketiga kuartil' },
      {
        ...
        baris: [
          ...
          'belahan kiri: 5 7 8 10 10 12 15   mediannya 10, jadi Q1 = 10',
          'belahan kanan: 18 20 22 25 30 35 60   mediannya 25, jadi Q3 = 25',
        ],
      ...
      },
      {
        ...
        langkah: [
          'Seret titik paling kanan mendekat ke kelompoknya. Apa yang terjadi pada kumisnya, dan apa yang terjadi pada kotaknya?',
          'Nyalakan tanda pagar 1,5 × JAK. Perhatikan titik mana yang berubah warna.',
          'Seret titik yang berada di dalam kotak. Sekarang bagian mana yang berubah?',
          'Jadi, bagian boxplot mana yang peka terhadap titik terjauh, dan bagian mana yang tidak?',
        ],
      },
    ],
    seringKeliru: {
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        langkah: [
          'Seret satu botol menjauh dari mean. Perhatikan sisi bawah perseginya dan luas perseginya.',
          'Bandingkan: saat jaraknya menjadi dua kali lipat, luas perseginya menjadi berapa kali lipat?',
          'Seret botol itu sejauh mungkin. Apa yang terjadi pada simpangan bakunya?',
          'Menurut Anda, mana yang lebih peka terhadap satu titik yang jauh: simpangan baku, atau jangkauan antar kuartil di Materi 07?',
        ],
      },
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        langkah: [
          'Sentuh satu baris tabel, lalu perhatikan batang mana yang ikut menyala.',
          'Geser garis median sampai luas di kirinya sama dengan luas di kanannya.',
          'Bandingkan letak garis yang Anda temukan dengan hasil rumus interpolasi. Sama atau beda?',
          'Kalau keduanya jatuh di titik yang sama, apa yang sebenarnya dihitung rumus interpolasi itu?',
        ],
      },
      {
        jenis: 'coba',
        ...
        langkah: [
          'Biarkan tetangga kiri di 8, lalu naikkan tetangga kanan sampai 11. Ke arah mana garis modus bergeser, dan dari berapa menjadi berapa?',
          'Naikkan tetangga kiri sampai 11 juga, sehingga kedua tetangganya sama tinggi. Di mana modusnya sekarang?',
          'Turunkan tetangga kanan sampai 0. Ke arah mana modusnya condong?',
          'Selama ketiga langkah tadi, apakah batang tertingginya pernah berpindah? Lalu apa yang menarik modus ke kiri atau ke kanan?',
        ],
      },
    ],
    seringKeliru: {
