...
export const KUIS: SoalKuis[] = [
  // ================================================================ MUDAH
  {
    ...
    pilihan: ['10 cm', '10√2 cm', '10√3 cm', '20 cm', '100 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, panjang diagonal sisi AC adalah 10√2 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 10√3 cm, adalah panjang diagonal RUANG (misalnya AG) yang menembus kubus, bukan diagonal bidang. Pilihan D, 20 cm, menjumlahkan AB + BC, seolah jalan terpendek dari A ke C menyusur rusuk.',
  ...
  },
  {
    ...
    pilihan: ['5√2 cm', '5√3 cm', '5√5 cm', '10 cm', '15 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, panjang diagonal ruang AG adalah 5√3 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 5√2 cm, berhenti pada diagonal bidang AC; teorema Pythagoras harus dipakai dua kali. Pilihan C, 5√5 cm, menjumlahkan 25 + 100 karena AC keliru dianggap 10 cm.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan garis AB terhadap garis HG adalah sejajar. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, bersilangan, menggoda karena AB dan HG tidak berada pada satu sisi kubus, padahal keduanya sebidang pada bidang diagonal ABGH. Bersilangan berarti tidak sejajar DAN tidak berpotongan, seperti AB dengan CG.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan garis AB terhadap garis CG adalah bersilangan. (Jawaban C)',
    ],
    jebakan: 'Pilihan A, berpotongan, mengira dua garis yang tampak menyilang pada gambar benar-benar bertemu, padahal persilangan pada gambar hanyalah akibat proyeksi ke kertas. Pilihan E menyerah, padahal kedudukannya bisa ditentukan dari definisi.',
  ...
  },
  {
    ...
    pilihan: ['3,5 cm', '7 cm', '7√2 cm', '7√3 cm', '14 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, jarak bidang alas ABCD ke bidang tutup EFGH adalah 7 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 7√2 cm, dan pilihan D, 7√3 cm, adalah panjang diagonal, padahal jarak selalu diukur sepanjang ruas yang tegak lurus, yang paling pendek. Pilihan A, 3,5 cm, membagi dua tanpa alasan.',
  ...
  },
  {
    ...
    pilihan: ['13 cm', '12 cm', '√185 cm', '17 cm', '4√10 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, panjang diagonal bidang AC adalah 13 cm. (Jawaban A)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan garis AG terhadap bidang alas ABCD adalah menembus bidang. (Jawaban C)',
    ],
    jebakan: 'Pilihan D, tegak lurus bidang, menggoda karena AG "naik" dari alas, padahal AG miring; yang tegak lurus alas adalah rusuk AE. Pilihan A keliru karena hanya titik A yang terletak pada bidang, bukan seluruh garis.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan garis EF terhadap bidang alas ABCD adalah sejajar bidang. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan bidang ABCD terhadap bidang EFGH adalah sejajar. (Jawaban B)',
    ],
    jebakan: 'Pilihan D, bersilangan, hanya berlaku untuk dua garis, bukan dua bidang; dua bidang hanya mungkin sejajar, berpotongan, atau berimpit. Pilihan E, tegak lurus, berlaku untuk alas dengan bidang sisi tegak seperti ABFE, bukan dengan tutupnya.',
  ...
  },
  {
    ...
    pilihan: ['8 cm', '8√2 cm', '8√3 cm', '16 cm', '4√2 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, panjang BG adalah 8√2 cm. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    pilihan: ['√22 m', '√13 m', '5 m', '√34 m', '7 m'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak lampu ke sakelar adalah √22 m. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, √13 m, hanya jarak mendatar dari sakelar ke titik di bawah lampu; tingginya belum diperhitungkan. Pilihan D, √34 m, memakai ukuran penuh 3, 4, 3, padahal lampu di pusat sehingga jarak mendatarnya setengah panjang dan setengah lebar.',
  ...
  },
  {
    ...
    pilihan: ['9 cm', '9√2 cm', '9√3 cm', '4,5 cm', '18 cm'],
    benar: 0,
    langkah: [
      ...
      'Jadi, jarak titik E ke garis AB adalah 9 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 9√2 cm, adalah panjang EB, ruas miring dari E ke ujung garis, bukan ruas yang tegak lurus. Pilihan D, 4,5 cm, mengira jarak diukur ke titik tengah AB.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan garis AE terhadap bidang alas ABCD adalah tegak lurus bidang. (Jawaban C)',
    ],
    jebakan: 'Pilihan D, bersilangan dengan bidang, memakai istilah untuk dua garis; garis dan bidang hanya bisa sejajar, terletak, atau menembus (termasuk tegak lurus). Pilihan B keliru karena hanya titik A yang ada di alas.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, bidang ABFE dan bidang BCGF berpotongan pada garis BF. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    pilihan: ['6 cm', '6√2 cm', '6√3 cm', '3 cm', '12 cm'],
    benar: 0,
    langkah: [
      ...
      'Jadi, jarak titik B ke bidang ADHE adalah 6 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 6√2 cm, adalah panjang BE atau BD, ruas miring ke titik lain pada bidang, bukan ruas tegak lurusnya. Pilihan D, 3 cm, mengira bidang ADHE berada di tengah kubus.',
  ...
  // =============================================================== SEDANG
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], ruas: [['A', 'C']] },
    pilihan: ['3 cm', '3√2 cm', '6 cm', '6√2 cm', '2√6 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, jarak titik B ke garis AC adalah 3√2 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 6 cm, mengambil panjang rusuk AB, padahal AB tidak tegak lurus AC. Pilihan D, 6√2 cm, adalah panjang seluruh diagonal, bukan setengahnya.',
  ...
  },
  {
    ...
    pilihan: ['2√3 cm', '3√2 cm', '2√6 cm', '6 cm', '6√3 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik A ke bidang BDE adalah 2√3 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 3√2 cm, adalah AJ, jarak A ke garis BD, bukan ke bidangnya; bidang BDE miring sehingga jaraknya lebih pendek lagi. Pilihan D, 6 cm, mengambil rusuk AE, padahal AE tidak tegak lurus bidang BDE.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, besar sudut antara garis AH dan garis AF adalah 60°. (Jawaban C)',
    ],
    jebakan: 'Pilihan B, 45°, adalah sudut antara diagonal bidang dengan rusuk (misalnya AF dengan AB), bukan antara dua diagonal bidang. Pilihan D, 90°, mengira dua diagonal pada sisi berbeda selalu tegak lurus.',
  ...
  },
  {
    ...
    pilihan: ['10 cm', '6√2 cm', '2√13 cm', '8 cm', '2√10 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik P ke garis AE adalah 10 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 6√2 cm, adalah jarak C ke AE (diagonal alas), lupa bahwa P berada 2 cm di luar C. Pilihan D, 8 cm, hanya panjang DP; jarak ke AE harus diukur dari A, bukan dari D.',
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], ruas: [['A', 'G']], bidang: ['A', 'B', 'C', 'D'] },
    pilihan: ['kira-kira 30°', 'kira-kira 35,26°', 'kira-kira 45°', 'kira-kira 54,74°', 'kira-kira 60°'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara diagonal ruang AG dan bidang alas ABCD kira-kira 35,26°. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 45°, memakai segitiga dengan dua kaki sama (diagonal bidang dengan rusuk), padahal di sini kakinya s dan s√2. Pilihan D, 54,74°, adalah ∠AGC, sudut di puncak segitiga, bukan sudut di A.',
  ...
  },
  {
    ...
    pilihan: ['4√3 cm', '4√6 cm', '6√2 cm', '12 cm', '2√3 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik C ke bidang BDG adalah 4√3 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 6√2 cm, adalah CJ, jarak C ke garis BD, bukan ke bidang BDG yang miring. Pilihan D, 12 cm, mengambil rusuk CG yang tidak tegak lurus bidang BDG.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, kedudukan garis AC terhadap garis BG adalah bersilangan. (Jawaban C)',
    ],
    jebakan: 'Pilihan A, berpotongan di B, menggoda karena B adalah ujung BG dan terlihat dekat AC pada gambar, padahal B bukan titik pada garis AC (B dan AC hanya sebidang). Pilihan E keliru karena G berada di luar bidang alas.',
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], ruas: [['A', 'G']] },
    pilihan: ['2√3 cm', '2√6 cm', '3√2 cm', '6 cm', '6√2 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, jarak titik E ke garis AG adalah 2√6 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan D, 6 cm, adalah AE, ruas dari E ke ujung garis, bukan ruas yang tegak lurus AG. Pilihan C, 3√2 cm, mengira kaki O membagi AG jadi dua dan memakai setengah EG.',
  ...
  },
  {
    ...
    pilihan: ['60/13 cm', '5 cm', '12 cm', '13/2 cm', '65/12 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik B ke garis AC adalah 60/13 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan D, 13/2 cm, mengira kaki O di tengah AC seperti pada persegi; itu hanya berlaku bila AB = BC. Pilihan B, 5 cm, mengambil rusuk BC yang tidak tegak lurus AC.',
  ...
  },
  {
    ...
    pilihan: ['30°', '45°', '60°', 'kira-kira 35,26°', '90°'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara garis AF dan bidang alas ABCD adalah 45°. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    pilihan: ['4√6 cm', '4√2 cm', '8√2 cm', '4√3 cm', '8 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik G ke garis BD adalah 4√6 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 8√2 cm, adalah GB atau GD, ruas miring ke ujung garis, bukan ruas tegak lurusnya. Pilihan B, 4√2 cm, hanya CP, jarak mendatar di alas, tanpa memperhitungkan tinggi CG.',
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], ruas: [['A', 'B'], ['H', 'G']] },
    pilihan: ['6 cm', '6√2 cm', '6√3 cm', '12 cm', '3√2 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, jarak antara garis AB dan garis HG adalah 6√2 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 6 cm, adalah jarak AB ke EF atau ke DC (rusuk yang bersebelahan), padahal HG berada di seberang, terpisah oleh lebar dan tinggi kubus. Pilihan C, 6√3 cm, adalah diagonal ruang, yang tidak tegak lurus pada AB.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, besar sudut antara garis BG dan garis DE adalah 90°. (Jawaban D)',
    ],
    jebakan: 'Pilihan C, 60°, adalah sudut antara dua diagonal bidang yang bertemu di satu titik sudut (misalnya AF dan AH), bukan dua diagonal pada sisi yang sejajar. Pilihan E, 0°, mengira BG ∥ DE, padahal yang sejajar DE adalah CF.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, besar sudut antara bidang BDG dan bidang alas ABCD kira-kira 54,74°. (Jawaban D)',
    ],
    jebakan: 'Pilihan B, 35,26°, adalah sudut diagonal ruang dengan alas (tan = 1/√2), kebalikan dari perbandingan di sini. Pilihan C, 45°, mengira CP sama panjang dengan CG, padahal CP hanya setengah diagonal.',
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], ruas: [['A', 'G']], bidang: ['A', 'B', 'C', 'D'] },
    pilihan: ['6 cm', '6√2 cm', '6√3 cm', '3√2 cm', '12 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, panjang proyeksi diagonal ruang AG pada bidang alas adalah 6√2 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 6√3 cm, adalah panjang AG sendiri; proyeksi selalu lebih pendek daripada ruas miringnya. Pilihan A, 6 cm, mengira bayangan AG hanya sepanjang satu rusuk.',
  ...
  // ================================================================ SULIT
  {
    ...
    pilihan: ['√8 cm', '√12 cm', '√14 cm', '√18 cm', '√20 cm'],
    benar: 3,
    langkah: [
      {
      ...
      'Jadi, jarak titik P ke garis CF adalah √18 cm. (Jawaban D)',
    ],
    jebakan: 'Pilihan E, √20 cm, adalah panjang PF, ruas miring dari P ke ujung garis, bukan ruas tegak lurusnya. Pilihan B, √12 cm, muncul bila kaki O dianggap di tengah CF (PO² = 20 − 8), padahal PF ≠ PC sehingga O tidak di tengah.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Untuk itu, θ = 30°.',
      'Jadi, besar sudut antara garis AH dan bidang BDHF adalah 30°. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 45°, adalah sudut AH dengan bidang alas atau dengan rusuk AD, bukan dengan bidang diagonal. Pilihan C, 60°, menukar sinus dengan kosinus (cos 60° = 1/2), padahal AP adalah sisi DEPAN sudut θ.',
  ...
  },
  {
    ...
    pilihan: ['3√2 cm', '(9/2)√2 cm', '6 cm', '3√6 cm', '6√2 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, jarak titik M ke garis BD adalah (9/2)√2 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan D, 3√6 cm, muncul bila kaki O dianggap di tengah BD (MO² = 45 − 18 = 27), padahal MB ≠ MD. Pilihan C, 6 cm, mengambil tinggi kubus, seolah BD tepat di bawah M.',
  ...
  },
  {
    ...
    pilihan: ['10 cm', '8 cm', '2√41 cm', '6 cm', '2√17 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik P ke garis BC adalah 10 cm. (Jawaban A)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, besar sudut antara garis AF dan garis BG adalah 60°. (Jawaban C)',
    ],
    jebakan: 'Pilihan E, 90°, mengira dua diagonal pada sisi yang bersebelahan tegak lurus; yang tegak lurus adalah dua diagonal pada SATU sisi (misalnya BG dan CF). Pilihan B, 45°, adalah sudut diagonal bidang dengan rusuk.',
  ...
  },
  {
    ...
    pilihan: ['2√3 cm', '3√3 cm', '4√3 cm', '6 cm', '3√2 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak antara bidang AFH dan bidang BDG adalah 2√3 cm. (Jawaban A)',
    ],
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], ruas: [['A', 'C']] },
    pilihan: ['3√6 cm', '3√2 cm', '6√2 cm', '3√3 cm', '6 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik H ke garis AC adalah 3√6 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 6√2 cm, adalah HA atau HC, ruas miring ke ujung garis. Pilihan B, 3√2 cm, hanya DP, jarak mendatar di alas, tanpa tinggi DH.',
  ...
  },
  {
    ...
    pilihan: ['(3/2)√2 cm', '3√2 cm', '3 cm', '1,5 cm', '2√3 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik P ke bidang BDHF adalah (3/2)√2 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 3√2 cm, adalah jarak A ke bidang BDHF; P berada di tengah AB sehingga jaraknya tinggal setengah. Pilihan C, 3 cm, mengambil PB, ruas miring dari P ke bidang, bukan ruas tegak lurusnya.',
  ...
  },
  {
    ...
    pilihan: ['kira-kira 19,47°', 'kira-kira 26,57°', 'kira-kira 35,26°', '45°', '30°'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara AG dan bidang alas kira-kira 19,47°. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 35,26°, adalah jawaban untuk KUBUS (tan = 1/√2), padahal tinggi balok ini hanya setengah sisi alasnya. Pilihan B, 26,57°, memakai tan = 3/6, yaitu CG dibagi rusuk BC, bukan dibagi diagonal AC.',
  ...
  },
  {
    ...
    pilihan: ['3√3 cm', '2√3 cm', '4√3 cm', '6√3 cm', '3√2 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik P ke bidang BDE adalah 3√3 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 2√3 cm, adalah jarak C (atau A) ke bidang, dan pilihan C, 4√3 cm, adalah jarak G; P berada tepat di antara keduanya. Pilihan E, 3√2 cm, mengira jaraknya setengah diagonal bidang.',
  ...
  },
  {
    ...
    pilihan: ['30°', '45°', '60°', 'kira-kira 35,26°', 'kira-kira 54,74°'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara bidang ABGH dan bidang alas ABCD adalah 45°. (Jawaban B)',
    ],
    jebakan: 'Pilihan E, 54,74°, adalah sudut bidang BDG dengan alas, yang kakinya s dan (1/2)s√2. Di sini kedua kakinya sama, s dan s. Pilihan D, 35,26°, adalah sudut diagonal ruang dengan alas.',
  ...
  },
  {
    ...
    pilihan: ['45°', 'kira-kira 51,34°', 'kira-kira 59,04°', 'kira-kira 35,26°', '30°'],
    benar: 0,
    langkah: [
      {
        teks: 'Perhatikan sketsa berikut. Proyeksi G pada bidang alas adalah C, sehingga proyeksi AG adalah AC dan sudut yang dicari adalah ∠GAC.',
      ...
      'Jadi, besar sudut antara AG dan bidang alas ABCD adalah 45°. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 51,34°, memakai tan = 10/8 (CG dibagi rusuk AB), dan pilihan C, 59,04°, memakai tan = 10/6; keduanya lupa bahwa proyeksi AG adalah diagonal AC, bukan rusuk. Pilihan D, 35,26°, adalah jawaban untuk kubus.',
  ...
  // ========================================================= SANGAT SULIT
  {
    ...
    pilihan: ['2√6 cm', '3√3 cm', '3√2 cm', '4√2 cm', '2√3 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik T ke bidang alas ABC adalah 2√6 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 3√3 cm, adalah tinggi segitiga sisi (AM atau TM), bukan tinggi limas; bidang sisi miring, sehingga tinggi limas lebih pendek. Pilihan E, 2√3 cm, adalah AO, jarak titik sudut alas ke titik berat, yang baru salah satu kaki segitiga TOA.',
  ...
  },
  {
    ...
    pilihan: ['kira-kira 33,69°', 'kira-kira 41,81°', 'kira-kira 48,19°', 'kira-kira 53,13°', 'kira-kira 56,31°'],
    benar: 3,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara bidang TAB dan bidang alas kira-kira 53,13°. (Jawaban D)',
    ],
    jebakan: 'Pilihan A, 33,69°, memakai tan = 4/6, yaitu tinggi dibagi seluruh sisi alas, padahal kakinya hanya OM = 3 cm (setengah sisi). Pilihan B, 41,81°, adalah sudut rusuk TA dengan alas (tan = 4/(3√2)), bukan sudut bidang sisinya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, jarak titik A ke bidang BDHF adalah 4,8 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 5 cm, mengira kaki O di tengah BD seperti pada kubus (setengah diagonal); itu hanya berlaku bila AB = AD. Pilihan D, 6,4 cm, adalah BO (= AB²/BD), letak kaki, bukan tinggi AO.',
  ...
  },
  {
    ...
    pilihan: ['2√3 cm', '3√3 cm', '4√3 cm', '3√2 cm', '6 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, jarak titik M ke bidang BDG adalah 3√3 cm. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 2√3 cm, adalah jarak A ke bidang, dan pilihan C, 4√3 cm, adalah jarak E; M berada tepat di tengah keduanya. Pilihan E, 6 cm, mengambil rusuk, seolah bidang BDG sejajar dengan sisi kubus.',
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], bidang: ['A', 'C', 'H'] },
    pilihan: ['2√3 cm', '3√3 cm', '4√3 cm', '6√3 cm', '3√6 cm'],
    benar: 2,
    langkah: [
      {
      ...
      'Jadi, jarak titik F ke bidang ACH adalah 4√3 cm. (Jawaban C)',
    ],
    jebakan: 'Pilihan A, 2√3 cm, adalah jarak D ke bidang ACH, titik sudut yang tetangganya ada di bidang itu; F berada di ujung lain diagonal. Pilihan D, 6√3 cm, adalah seluruh diagonal DF.',
  ...
  },
  {
    ...
    pilihan: ['√6 cm', '2√6 cm', '3√2 cm', '2√3 cm', '3 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik A ke bidang BDP adalah √6 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 3√2 cm, adalah AJ, jarak A ke garis BD, bukan ke bidang BDP yang miring. Pilihan D, 2√3 cm, adalah jarak A ke bidang BDE; bidang BDP lebih landai karena P hanya setengah tinggi.',
  ...
  },
  {
    ...
    pilihan: ['kira-kira 70,53°', '60°', 'kira-kira 54,74°', 'kira-kira 35,26°', '90°'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara diagonal ruang AG dan BH kira-kira 70,53°. (Jawaban A)',
    ],
    jebakan: 'Pilihan E, 90°, mengira dua diagonal ruang saling tegak lurus seperti diagonal persegi, padahal cos θ = 1/3 ≠ 0. Pilihan C, 54,74°, adalah sudut bidang BDG dengan alas; pilihan D, 35,26°, sudut diagonal ruang dengan alas.',
  ...
  },
  {
    ...
    pilihan: ['kira-kira 26,57°', '30°', '45°', 'kira-kira 63,43°', 'kira-kira 18,43°'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara garis BP dan bidang alas kira-kira 26,57°. (Jawaban A)',
    ],
    jebakan: 'Pilihan D, 63,43°, adalah ∠BPA, sudut di ujung atas, hasil menukar peran kedua kaki (tan = 6/3). Pilihan B, 30°, mengira tan 30° = 1/2, padahal yang bernilai 1/2 adalah sin 30°.',
  ...
  },
  {
    ...
    pilihan: ['kira-kira 70,53°', 'kira-kira 54,74°', '60°', 'kira-kira 35,26°', '90°'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, besar sudut antara bidang BDE dan bidang BDG kira-kira 70,53°. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 54,74°, adalah sudut SATU bidang (BDG) dengan alas; sudut antara kedua bidang miring itu bukan dua kalinya (109,47°) melainkan pelurusnya, 70,53°, karena keduanya condong ke arah yang berlawanan. Pilihan E, 90°, mengira EM ⟂ GM.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, jarak antara garis AC dan garis HB adalah √6 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 2√6 cm, adalah jarak D ke HB, dua kali jarak yang dicari, karena AC memotong BD tepat di tengahnya. Pilihan C, 3√2 cm, adalah OB, jarak O ke ujung garis, bukan ruas tegak lurusnya.',
  ...
  },
  {
    ...
    pilihan: ['3√2 cm', '6 cm', '2√6 cm', '3√3 cm', '6√2 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak antara garis AG dan garis CD adalah 3√2 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 6 cm, mengambil rusuk DA atau CG, padahal keduanya tidak tegak lurus AG. Pilihan E, 6√2 cm, adalah seluruh diagonal, bukan setengahnya.',
  ...
  },
  {
    ...
    gambar: { jenis: 'balok', ukuran: [1, 1, 1], bidang: ['B', 'D', 'P'], tambahan: [{ nama: 'P', di: [1, 1, 0.5] }] },
    pilihan: ['kira-kira 35,26°', '45°', 'kira-kira 54,74°', '30°', 'kira-kira 26,57°'],
    benar: 0,
    langkah: [
      {
      ...
      'Untuk itu, θ = arctan(0,7071) ≈ 35,26°.',
      'Jadi, besar sudut antara bidang BDP dan bidang alas kira-kira 35,26°. (Jawaban A)',
    ],
  ...
  },
  {
    ...
    pilihan: ['(3/2)√2 cm', '3√2 cm', '3 cm', '1,5 cm', '(3/2)√3 cm'],
    benar: 0,
    langkah: [
      {
      ...
      'Jadi, jarak titik A ke bidang diagonal CDEF adalah (3/2)√2 cm. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 3 cm, mengambil rusuk AD atau AE, padahal keduanya tidak tegak lurus bidang CDEF yang miring 45°. Pilihan B, 3√2 cm, adalah seluruh diagonal AH, bukan setengahnya.',
