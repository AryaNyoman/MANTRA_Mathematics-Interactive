...
export const TAHAP: Tahap[] = [
    ...
    penjelasan: [
      ...
      },
      {
        ...
        baris: [
          ...
          'Setengah diagonal alas: 3√2.',
          'BQ = 3√2, kira-kira 4,243.',
        ],
        simpul:
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    pertanyaan:
      'Kenapa diagonal ruang kubus rusuk 1 panjangnya √3, bukan √2 + 1?',
    ...
    penjelasan: [
      ...
      },
      {
        ...
        butir: [
          'Rusuk - a',
          'Diagonal sisi - a√2, melewati dua arah',
          'Diagonal ruang - a√3, melewati tiga arah',
        ],
      },
      {
        jenis: 'paragraf',
        teks:
          'Pada balok caranya sama persis, hanya angkanya tidak sama. Untuk balok berukuran p, l, dan t, diagonal ruangnya √(p² + l² + t²). Kubus cuma kejadian khusus saat ketiganya sama.',
      },
    ],
    seringKeliru: {
      judul: 'Dikira √2 + 1',
      isi:
        'Kekeliruan ini muncul karena akarnya diakarkan terlalu cepat. Setelah mendapat AC = 6√2, angka itu langsung dijumlahkan dengan rusuk 6 seolah keduanya searah. Padahal AC dan CG saling tegak lurus, jadi yang dijumlahkan adalah KUADRATNYA, bukan panjangnya. Kebiasaan yang menyelamatkan: simpan hasil langkah pertama dalam bentuk kuadrat, yaitu 72, dan baru akarkan di akhir.',
    },
    intisari: [
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        baris: [
          'AB = 6 (satu rusuk)',
          'BG = 6√2 (diagonal sisi kanan)',
          'AG = 6√3 (diagonal ruang)',
          'Periksa: 6² + (6√2)² = 36 + 72 = 108 = (6√3)². Benar siku-siku di B.',
        ],
      },
      ...
      },
      {
        ...
        baris: [
          'Pakai AB sebagai alas: luas = (1/2) · 6 · 6√2 = 18√2',
          'Pakai AG sebagai alas, tingginya BK: luas = (1/2) · 6√3 · BK',
          'Samakan: (1/2) · 6√3 · BK = 18√2',
          'BK = 36√2/(6√3) = 6√2/√3',
          'Rasionalkan: BK = 6√6/3 = 2√6',
        ],
        simpul: 'BK = 2√6, kira-kira 4,899 satuan.',
      },
      {
        jenis: 'sorot',
        teks:
      ...
      },
      {
        ...
        baris: [
          ...
          'Langkah 1, siapkan ketiga sisi segitiga PCF. CF diagonal sisi, jadi 4√2.',
          'PF seluruhnya ada di bidang tutup EFGH, jadi Pythagoras sekali: PF = akar (4² + 2²) = 2√5.',
          'PC menembus dalam kubus. Turunkan P ke alas, bayangannya jatuh di tengah AD, dan jaraknya ke C juga 2√5. Lalu PC = akar (20 + 4²) = 6.',
          'Langkah 2, sebut kaki tegak lurusnya K dan misalkan CK = x. Tinggi PK bisa ditulis dua kali:',
          'dari segitiga PCK: PK² = 6² - x² = 36 - x²',
          'dari segitiga PFK: PK² = (2√5)² - (4√2 - x)² = 20 - (4√2 - x)²',
          'Langkah 3, samakan keduanya. Suku x² saling menghapus, tersisa 36 = -12 + 8√2 · x, jadi x = 3√2.',
          'Langkah 4, kembali ke baris pertama: PK² = 36 - 18 = 18, jadi PK = 3√2.',
        ],
        simpul:
          'PK = 3√2, kira-kira 4,243. Sumber: soal UAN 2003. Soal yang sama ada di Latihan nomor 3, dikerjakan dengan cara koordinat sebagai pembanding.',
      },
    ],
    seringKeliru: {
    ...
    intisari: [
      ...
      'Dua jalan: segitiga siku-siku, atau jalan pintas d = 2L/a (dua kali luas dibagi alas).',
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        baris: [
          'AG = 6√3',
          'AK = sepertiga dari AG = 2√3',
        ],
        simpul: 'AK = 2√3, kira-kira 3,464 satuan.',
      },
      ...
      },
      {
        ...
        baris: [
          ...
          'luas ABD = (1/2) · 6 · 6 = 18, tingginya AE = 6',
          'volume = (1/3) · 18 · 6 = 36',
          'Cara 2, alasnya segitiga BDE yang miring:',
          'BDE segitiga sama sisi bersisi 6√2, luasnya 18√3',
          'volume = (1/3) · 18√3 · AK',
          'Samakan: (1/3) · 18√3 · AK = 36',
          'AK = 36/(6√3) = 2√3',
        ],
        simpul: 'Hasilnya sama, 2√3. Dua cara berbeda, satu jawaban.',
      },
      {
        jenis: 'sorot',
        teks:
          'Jarak titik ke bidang d = 3V/L, dengan V volume limas dan L luas alasnya. Sama seperti sebelumnya, ini rumus volume yang dibalik, bukan hafalan baru.',
      },
      ...
      },
      {
        ...
        baris: [
          ...
          'Cara 1, alasnya segitiga BCD yang datar di lantai: luas = (1/2) · 6 · 6 = 18, tingginya CG = 6.',
          'volume = (1/3) · 18 · 6 = 36',
          'Cara 2, alasnya segitiga BDG yang miring. BD, BG, dan DG ketiganya diagonal sisi, jadi sama panjang 6√2, dan segitiganya sama sisi. Luasnya 18√3.',
          'Samakan: (1/3) · 18√3 · jarak = 36, jadi jarak = 36/(6√3) = 2√3.',
          'Cara simetri juga jalan di sini: CB, CD, dan CG saling tegak lurus dan sama panjang, jadi kakinya jatuh di sepertiga diagonal ruang CE. CE = 6√3, dan sepertiganya 2√3.',
        ],
        simpul:
          'Dua cara, satu jawaban: 2√3 cm, kira-kira 3,464. Sumber: soal EBTANAS 1992.',
      },
    ],
    seringKeliru: {
    ...
    intisari: [
      ...
      'Pada kubus rusuk 6, jarak A ke bidang BDE adalah 2√3.',
      'Jalan pintas volume: d = 3V/L, tiga kali volume dibagi luas alas.',
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        baris: [
          'AC diagonal sisi alas: 6√2',
          'AH diagonal sisi kiri: 6√2',
          'CH diagonal sisi belakang: 6√2',
      ...
      },
      {
        ...
        baris: [
          ...
          'c² = a² + b² - 2ab cos C',
          'Dibalik untuk mencari sudutnya: cos C = (a² + b² - c²)/(2ab).',
          'Coba pada segitiga ACH tadi. Ketiga sisinya 6√2, jadi ketiga kuadratnya 72.',
          'cos C = (72 + 72 - 72)/(2 · 72) = 72/144 = 1/2.',
    ...
    penjelasan: [
      ...
      },
      {
        ...
        baris: [
          ...
          'Langkah 3, ambil rusuk 6 supaya ada angkanya. AP = 3√2, setengah diagonal alas. AH = 6√2, diagonal sisi.',
          'Segitiga APH siku-siku di P, dan AP adalah sisi depan sudut yang dicari sedangkan AH sisi miringnya.',
          'sin sudut = AP/AH = 3√2/(6√2) = 1/2.',
          'Sudut yang sinusnya setengah adalah 30 derajat.',
        ],
        simpul:
          'Jawabannya 30 derajat, dan panjang rusuknya tidak berpengaruh: √2 pada pembilang dan penyebut saling menghapus. Sumber: soal UAN 2005.',
      },
    ],
    seringKeliru: {
