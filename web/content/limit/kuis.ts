...
export const KUIS: SoalKuis[] = [
  // ================================================================ MUDAH
  {
    ...
    langkah: [
      ...
      'Jadi, pernyataan yang tepat adalah ke mana f(x) menuju saat x mendekati c dari kiri dan dari kanan. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→3 (x + 4) = 7. (Jawaban C)',
    ],
  ...
  },
  {
    ...
    jebakan: 'Pilihan B, 5, membaca nilai f(2) dari noktah hitam, padahal limit dibaca dari arah kurva. Pilihan C, tidak ada, mengira loncatan noktah membuat limit gagal; yang membuat limit tidak ada adalah limit kiri dan kanan yang berbeda.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai lim x→c f(x) = 5. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 10, menjumlahkan kedua limit sepihak, padahal keduanya menunjuk nilai yang SAMA, bukan dua bagian yang digabung. Pilihan E menggoda karena f(c) terasa penting, padahal limit tidak bergantung pada nilai fungsi tepat di c.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→−3 x² = 9. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, −9, lupa bahwa kuadrat bilangan negatif bernilai positif; (−3)² bukan −(3²). Pilihan C, −6, mengalikan −3 dengan 2 alih-alih mengkuadratkannya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→2 (2f(x) − 3g(x)) = 11. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 5, menghitung 8 − 3, lupa bahwa g(x) menuju −1 sehingga −3(−1) = +3. Pilihan C, 8, hanya menghitung suku pertama.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→1 (2x + 1)/(x + 3) = 3/4. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 4/3, membalik pecahan, penyebut dibagi pembilang. Pilihan E, tidak ada, mengira setiap limit pecahan bermasalah, padahal masalah hanya muncul bila penyebutnya menjadi 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→2 (3x − 1) = 5. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 6, berhenti pada 3 × 2 tanpa mengurangkan 1. Pilihan C, 2, menyalin nilai yang didekati x, padahal yang ditanya nilai fungsinya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (x² + 4)/(x + 2) = 2. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 4, hanya menghitung pembilangnya. Pilihan C, 0, mengira x → 0 membuat seluruh fungsi menuju 0, padahal suku tetap 4 dan 2 tidak ikut menghilang.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai lim x→1 f(x) = 2. (Jawaban A)',
    ],
    jebakan: 'Pilihan D, tidak ada karena titiknya kosong, mencampuradukkan nilai fungsi dengan limit; justru contoh inilah yang menunjukkan limit bisa ada tanpa f(1). Pilihan B, 1, menyalin absis lubang, bukan tingginya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→4 √x = 2. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 16, mengkuadratkan 4 alih-alih menarik akarnya. Pilihan B, 4, menyalin nilai yang didekati x tanpa menghitung fungsinya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai lim x→1⁻ f(x) yang paling masuk akal adalah 3. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 2,997, mengambil baris terakhir tabel seolah itu tujuannya, padahal tabel bisa diperpanjang (0,9999 memberi 2,9997) dan terus mendekati 3. Pilihan D, 1, menyalin nilai yang didekati x.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, lim x→0 1/x² tidak ada karena nilainya membesar tanpa batas. (Jawaban A)',
    ],
    jebakan: 'Pilihan D, 1 dibagi 0 sama dengan 0, adalah kekeliruan aritmetika: pembagian dengan nol tidak terdefinisi, bukan nol. Pilihan B, 0, menukar dengan lim x→∞ 1/x².',
  ...
  // =============================================================== SEDANG
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→5 (x² − 25)/(x − 5) = 10. (Jawaban C)',
    ],
    jebakan: 'Pilihan E, tidak ada, berhenti pada bentuk 0/0 seolah itu jawaban akhir, padahal 0/0 hanya tanda bahwa bentuknya harus ditulis ulang. Pilihan A, 0, mengambil pembilang 0 tanpa memperhatikan penyebut yang juga 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai lim x→1 f(x) = 2. (Jawaban C)',
    ],
    jebakan: 'Pilihan D, tidak ada karena f(1) tidak ada, mencampuradukkan nilai fungsi dengan limit; limit hanya melihat x di dekat 1. Pilihan E, tak hingga, mengira pembagian dengan nol selalu meledak, padahal pembilangnya juga menuju nol.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (sin x)/x = 1. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (3x + 1)/(x − 2) = 3. (Jawaban C)',
    ],
    jebakan: 'Pilihan B, 1/2, membagi konstanta 1 dengan −2 dengan tanda terbalik, padahal konstanta justru tidak berpengaruh ketika x sangat besar. Pilihan D, tak hingga, hanya melihat pembilang membesar tanpa membandingkannya dengan penyebut.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, yang bukan syarat kekontinuan adalah grafiknya tidak boleh punya sudut tajam di c. (Jawaban D)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→3 (x² − x − 6)/(x − 3) = 5. (Jawaban C)',
    ],
    jebakan: 'Pilihan D, 6, muncul dari pemfaktoran keliru (x − 3)(x + 3), seolah pembilangnya x² − 9. Pilihan B, 3, menyalin nilai yang didekati x.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (2x + 7)/(x² + 1) = 0. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 2, mengambil koefisien pangkat tertinggi pembilang dibagi koefisien penyebut, padahal aturan "perbandingan koefisien" hanya berlaku bila derajat pembilang dan penyebut SAMA. Pilihan D, tak hingga, hanya melihat pembilang membesar.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (sin 4x)/(2x) = 2. (Jawaban C)',
    ],
    jebakan: 'Pilihan A, 1/2, membalik perbandingan menjadi b/a = 2/4. Pilihan B, 1, memakai lim (sin u)/u = 1 tanpa memperhatikan bahwa sudutnya 4x sedangkan penyebutnya 2x.',
  ...
  },
  {
    ...
    pilihan: ['tidak ada; nilainya menuju negatif tak hingga', '4', '0', '1', 'tidak ada; nilainya menuju positif tak hingga'],
    benar: 0,
    langkah: [
      ...
      'Jadi, lim x→4⁻ x/(x − 4) tidak ada; nilainya menuju negatif tak hingga. (Jawaban A)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (sin 3x)/x = 3. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 1, memakai lim (sin u)/u = 1 tanpa menyamakan sudut 3x dengan penyebut x. Pilihan D, 1/3, membalik pengalinya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (2x² + 1)/(x² − 3) = 2. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, −1/3, membagi konstanta 1 dengan −3, padahal konstanta tidak berpengaruh ketika x sangat besar. Pilihan D, tak hingga, hanya melihat pembilang membesar tanpa membandingkannya dengan penyebut yang membesar sama cepatnya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (tan x)/x = 1. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 0, hanya melihat tan 0 = 0 tanpa memperhatikan penyebut yang juga menuju 0. Pilihan D, tak hingga, mengira tangen selalu meledak; itu terjadi di dekat 90°, bukan di dekat 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (x³ − 1)/(2x³ + x) = 1/2. (Jawaban A)',
    ],
  ...
  // ================================================================ SULIT
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (√(x + 9) − 3)/x = 1/6. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 0, berhenti pada pembilang √9 − 3 = 0 tanpa memperhatikan penyebut yang juga 0. Pilihan C, 1/3, lupa menambahkan 3 pada penyebut setelah sekawan (memakai 1/√9 saja).',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (tan 3x)/(sin 5x) = 3/5. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→2 (x³ − 8)/(x − 2) = 12. (Jawaban D)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→2 (x² − 4)/(x² − x − 2) = 4/3. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 3/4, membalik pecahan hasil akhir. Pilihan A, 1, mengira dua polinom berderajat sama selalu berlimit 1; itu aturan untuk x → ∞, bukan x → 2.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (1 − cos x)/x = 0. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 1/2, adalah nilai lim (1 − cos x)/x², dengan penyebut x KUADRAT; di sini penyebutnya hanya x sehingga masih tersisa faktor sin(x/2) yang menuju 0. Pilihan C, 1, mengira semua limit trigonometri bentuk 0/0 bernilai 1.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (√(x² + 3x) − x) = 3/2. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 0, mengira ∞ − ∞ selalu 0, padahal itu bentuk taktentu. Pilihan C, 3, lupa membagi dengan 2 (penyebut √1 + 1 = 2 setelah sekawan).',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, limit tersebut tidak ada. (Jawaban D)',
    ],
    jebakan: 'Pilihan A, 1, hanya memeriksa sisi kanan; pilihan B, −1, hanya sisi kiri. Pilihan C, 0, mengambil rata-rata keduanya, padahal limit tidak berkompromi.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (√(1 + x) − 1)/x = 1/2. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 1, lupa menambahkan 1 pada penyebut setelah sekawan (memakai 1/√1 saja). Pilihan C, 0, berhenti pada pembilang √1 − 1 = 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→2 (1/(x − 2) − 4/(x² − 4)) = 1/4. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, tidak ada, berhenti pada ∞ − ∞ seolah itu jawaban akhir, padahal kedua pecahan saling meniadakan bagian yang meledak. Pilihan B, 0, mengira ∞ − ∞ selalu 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (1 − cos x)/x² = 1/2. (Jawaban A)',
    ],
    jebakan: 'Pilihan D, 2, berhenti pada 2 sin²(x/2)/x² dan menganggap sin²(x/2)/x² → 1, lupa bahwa penyebutnya seharusnya (x/2)², bukan x². Pilihan B, 0, adalah nilai lim (1 − cos x)/x, dengan penyebut x pangkat satu.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (√(x² + 1) − x) = 0. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 1/2, meniru hasil soal √(x² + x) − x tanpa memeriksa bahwa di sini tidak ada suku x di dalam akar (b = 0). Pilihan B, 1, mengambil pembilang 1 setelah sekawan tanpa memperhatikan penyebut yang membesar.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→27 (x − 27)/(∛x − 3) = 27. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 9, hanya menghitung suku y² = 9 dari faktor kuadratnya. Pilihan C, 3, menyalin nilai ∛27. Pilihan D, 1/27, membalik pecahan hasil akhir.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (sin 2x)/(tan 3x) = 2/3. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 3/2, membalik perbandingan koefisien. Pilihan D, 6, mengalikan 2 dan 3 alih-alih membaginya. Pilihan C, 1, mengira sinus dan tangen "sama-sama 1" sehingga saling menghapus tanpa melihat koefisien sudutnya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→2 sin(x − 2)/(x² − 4) = 1/4. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (√(4x² + x) − 2x) = 1/4. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 1/2, memakai penyebut √4 = 2 saja dan lupa menambahkan 2x/x = 2. Pilihan A, 0, mengira ∞ − ∞ selalu 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai a supaya f kontinu di x = 2 adalah 0. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 1, muncul bila f(2) dihitung 2² − 3 = 2 (salah hitung) lalu 2a + 1 = 2 dipaksa; padahal 4 − 3 = 1. Pilihan E menyerah karena a = 0 terasa "tidak ada", padahal a = 0 adalah nilai yang sah.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (1 − cos 2x)/x² = 2. (Jawaban D)',
    ],
    jebakan: 'Pilihan B, 1/2, adalah nilai lim (1 − cos x)/x² (sudut x, bukan 2x); sudut 2x melipatkan hasilnya empat kali karena 2² = 4, dan (1/2) × 4 = 2. Pilihan E, 4, memakai 1 − cos 2x = 4 sin² x, keliru menuliskan identitasnya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→4 (√x − 2)/(√(x + 5) − 3) = 3/2. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 2/3, menukar tempat kedua sekawan (memakai (√x + 2)/(√(x + 5) + 3)); sekawan pembilang selalu pindah ke penyebut dan sebaliknya. Pilihan C, 1, mengira kedua akar "sama-sama nol" sehingga saling menghapus.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (tan x − sin x)/x³ = 1/2. (Jawaban C)',
    ],
    jebakan: 'Pilihan A, 0, mengira tan x dan sin x "sama-sama x" sehingga selisihnya 0; selisih keduanya memang menuju 0, tetapi sebanding dengan x³/2, sama cepatnya dengan penyebut. Pilihan B, 1/6, adalah nilai lim (x − sin x)/x³, soal yang serupa tetapi berbeda.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→0 (1 − cos x)/(x sin x) = 1/2. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 1, mengira setiap limit trigonometri bentuk 0/0 bernilai 1. Pilihan C, 0, hanya melihat pembilang 1 − cos x → 0 tanpa memperhatikan penyebut yang menuju 0 sama cepatnya (keduanya sebanding dengan x²).',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Untuk itu, a + b = 3 + (−4) = −1.',
      'Jadi, nilai a + b = −1. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 5, menyalin nilai limitnya. Pilihan B, 1, salah tanda pada b: dari 1 + a + b = 0 dengan a = 3 seharusnya b = −4, bukan 4.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (√(9x² + 12x − 5) − (3x + 1)) = 1. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 2, memakai rumus b/(2√a) = 12/6 seolah suku 3x + 1 hanya 3x; konstanta +1 ikut menyumbang 6x setelah dikuadratkan. Pilihan B, 0, mengira ∞ − ∞ selalu 0.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari lim x→∞ (2x + sin x)/x = 2. (Jawaban A)',
    ],
    jebakan: 'Pilihan B menggoda karena sin x memang tidak mempunyai limit di tak hingga, tetapi yang dibagi x adalah sin x, dan hasil bagi itu menuju 0. Pilihan C, 3, mengganti sin x dengan nilai terbesarnya 1 lalu menganggap 1/x tidak menghilang.',
