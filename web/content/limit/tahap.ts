    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Perhatikan kolom f(x) di tabel. Ke angka berapa nilainya menyempit?',
          'Sekarang tarik dari sebelah kanan. Menyempit ke angka yang sama, atau berbeda?',
          'Coba letakkan x tepat di titiknya. Apa yang dilakukan alat itu, dan menurut Anda kenapa?',
        ],
      },
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Pada tampilan biasa, perhatikan grafiknya. Adakah yang aneh di sekitar x = 1?',
          'Perbesar terus ke arah titik (1, 2).',
          'Apa yang muncul di titik itu: titik penuh, atau lingkaran kosong?',
          'Perhatikan penunjuk skala di pojok. Seberapa dekat Anda harus mengintip sampai lubangnya terlihat?',
        ],
      },
    ],
    seringKeliru: {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Kalau sifatnya tepat, perhatikan apa yang terjadi pada soalnya.',
          'Kalau keliru, baca alasan yang disebut mesin.',
          'Coba sengaja pakai sifat hasil bagi pada soal yang penyebutnya nol. Apa yang dikatakan mesin, dan menurut Anda kenapa?',
        ],
      },
    ],
    seringKeliru: {
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Mulai dari tampilan biasa. Perhatikan bentuk kurvanya.',
          'Perkecil tampilannya sedikit demi sedikit. Apa yang terjadi pada lengkungannya?',
          'Pada tampilan yang sangat kecil, bandingkan kurva dengan garis asimtotnya.',
          'Sekarang lihat tabel angkanya. Apakah selisih keduanya benar-benar nol, atau hanya tidak terlihat?',
        ],
      },
    ],
    seringKeliru: {
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Mulai dari sudut besar. Bandingkan panjang busur dengan panjang ruas sin.',
          'Kecilkan sudutnya pelan-pelan. Apa yang terjadi pada keduanya?',
          'Perhatikan angka perbandingannya setiap kali sudutnya dikecilkan. Menuju ke angka berapa?',
          'Mana yang selalu sedikit lebih panjang, busur atau ruas sin? Menurut Anda, apa akibatnya pada perbandingannya?',
        ],
      },
    ],
    seringKeliru: {
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Tekan "bikin lubang". Syarat nomor berapa yang menyala merah?',
          'Tekan "geser satu titik". Sekarang syarat mana yang gagal? Perhatikan: nilainya ada, limitnya ada, tetapi ada yang tidak cocok.',
          'Tekan "bikin lompat". Syarat mana yang gagal kali ini, dan apa yang terjadi pada limit kiri dan kanan?',
          'Tekan "bikin asimtot", lalu kembalikan ke mulus. Kapan ketiga syaratnya menyala hijau bersamaan?',
        ],
      },
    ],
    seringKeliru: {
