...
export const KUIS: SoalKuis[] = [
  // ================================================================ MUDAH
  {
    ...
    pilihan: ['miring', 'depan', 'samping', 'alas', 'tegak'],
    benar: 0,
    langkah: [
      ...
      'Jadi, sisi yang menghadap sudut siku-siku disebut sisi miring. (Jawaban A)',
    ],
    jebakan: 'Pilihan E, tegak, dan pilihan D, alas, menyebut posisi sisi pada gambar, padahal nama sisi ditentukan oleh sudut yang ditinjau, bukan oleh arah gambarnya. Pilihan B, depan, adalah sisi di hadapan sudut θ, bukan di hadapan sudut siku-siku.',
  ...
  },
  {
    ...
    pilihan: ['depan : samping', 'samping : miring', 'miring : depan', 'samping : depan', 'depan : miring'],
    benar: 4,
    langkah: [
      {
      ...
      'Jadi, sin θ adalah perbandingan depan : miring. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, depan : samping, adalah definisi tan θ, sedangkan pilihan B, samping : miring, adalah definisi cos θ. Pilihan C, miring : depan, adalah kebalikan sinus, yaitu csc θ.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai tan 45° adalah 1. (Jawaban C)',
    ],
    jebakan: 'Pilihan B, √2, adalah panjang sisi miring segitiga acuan, padahal tangen tidak memakai sisi miring. Pilihan A, 0,5, keliru karena mengira 45° adalah setengah dari 90° sehingga nilainya juga setengah.',
  ...
  },
  {
    ...
    pilihan: ['0,8', '0,6', '0,75', '1,67', '0,375'],
    benar: 1,
    langkah: [
      ...
      'Jadi, nilai sin θ = 0,6. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 0,8, adalah cos θ = 4/5 dan pilihan C, 0,75, adalah tan θ = 3/4. Pilihan D, 1,67, muncul bila pecahannya terbalik menjadi 5/3, padahal nilai sinus tidak pernah melebihi 1.',
  ...
  },
  {
    ...
    pilihan: ['(sin θ, cos θ)', '(tan θ, 1)', '(1, tan θ)', '(cos θ, sin θ)', '(θ, sin θ)'],
    benar: 3,
    langkah: [
      {
      ...
      'Jadi, koordinat titik di ujung jari-jari bersudut θ adalah (cos θ, sin θ). (Jawaban D)',
    ],
    jebakan: 'Pilihan A, (sin θ, cos θ), menukar urutan koordinat; kekeliruan ini paling sering terjadi dan membuat semua tanda kuadran ikut terbalik. Pilihan B dan C memakai tan θ, padahal tangen adalah perbandingan kedua kaki, bukan koordinat titiknya.',
  ...
  },
  {
    ...
    pilihan: ['3π/4', '2π/3', '5π/6', '5π/3', '150π'],
    benar: 2,
    langkah: [
      ...
      'Jadi, besar sudut 150° dalam radian adalah 5π/6. (Jawaban C)',
    ],
    jebakan: 'Pilihan E, 150π, mengalikan dengan π tanpa membagi 180. Pilihan B, 2π/3, adalah 120°, dan pilihan A, 3π/4, adalah 135°; keduanya muncul dari salah menyederhanakan pecahan.',
  ...
  },
  {
    ...
    pilihan: ['90', '180', 'tak terhingga', '0,5', '1'],
    benar: 4,
    langkah: [
      ...
      'Jadi, nilai terbesar yang mungkin dicapai sin θ adalah 1. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, 90, mengacaukan nilai sinus dengan sudut tempat nilai itu tercapai. Pilihan C, tak terhingga, berlaku untuk tangen di dekat 90°, bukan untuk sinus.',
  ...
  },
  {
    ...
    gambar: { jenis: 'segitiga', sudut: 35, label: ['depan', 'samping', 'miring'], namaSudut: 'θ' },
    pilihan: ['depan : miring', 'depan : samping', 'samping : miring', 'miring : samping', 'samping : depan'],
    benar: 2,
    langkah: [
      {
      ...
      'Jadi, cos θ adalah perbandingan samping : miring. (Jawaban C)',
    ],
    jebakan: 'Pilihan A, depan : miring, adalah sin θ, dan pilihan B, depan : samping, adalah tan θ. Pilihan D, miring : samping, adalah kebalikan kosinus, yaitu sec θ.',
  ...
  },
  {
    ...
    pilihan: ['0,6', '0,75', '1,25', '0,8', '1,33'],
    benar: 3,
    langkah: [
      ...
      'Jadi, nilai cos θ = 0,8. (Jawaban D)',
    ],
    jebakan: 'Pilihan A, 0,6, adalah sin θ = 6/10 dan pilihan B, 0,75, adalah tan θ = 6/8. Pilihan C, 1,25, adalah pecahan yang terbalik, 10/8, padahal kosinus tidak pernah melebihi 1.',
  ...
  },
  {
    ...
    pilihan: ['8,66 cm', '10 cm', '20 cm', '5 cm', '3 cm'],
    benar: 3,
    langkah: [
      ...
      'Jadi, panjang sisi di depan sudut 30° adalah 5 cm. (Jawaban D)',
    ],
    jebakan: 'Pilihan A, 8,66 cm, adalah sisi samping (10 cos 30°), bukan sisi depan. Pilihan C, 20 cm, membagi 10 dengan 1/2 alih-alih mengalikannya, padahal sisi depan tidak mungkin lebih panjang dari sisi miring.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai terendah yang dicapai kurva y = sin x adalah −1. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, −90, dan pilihan D, −360, mengacaukan nilai fungsi (sumbu tegak) dengan sudut (sumbu mendatar). Pilihan B, 0, adalah nilai sinus pada 0° dan 180°, bukan nilai terendahnya.',
  ...
  // =============================================================== SEDANG
  {
    ...
    pilihan: ['0,417', '0,923', '2,400', '0,600', '0,385'],
    benar: 4,
    langkah: [
      ...
      'Jadi, nilai sin θ ≈ 0,385. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, 0,417, adalah 5/12, yaitu tan θ; sisi samping dipakai seolah-olah sisi miring. Pilihan B, 0,923, adalah cos θ = 12/13. Pilihan C, 2,400, adalah 12/5, pecahan tangen yang terbalik.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai cos θ = 0,8. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 0,4, mengurangkan 1 − 0,6 seolah sinus dan kosinus berjumlah 1; yang berjumlah 1 adalah kuadratnya, sin² θ + cos² θ = 1. Pilihan E, 0,36, berhenti pada sin² θ tanpa dikurangkan dari 1 dan ditarik akarnya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, periode grafik y = sin x adalah 360°. (Jawaban C)',
    ],
  ...
  },
  {
    ...
    pilihan: ['2,50 m', '2,89 m', '5,77 m', '10,00 m', '4,33 m'],
    benar: 4,
    langkah: [
      ...
      'Jadi, tinggi ujung tangga dari tanah kira-kira 4,33 m. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, 2,50 m, adalah jarak kaki tangga ke dinding (5 cos 60°), bukan tingginya. Pilihan C, 5,77 m, membagi 5 dengan sin 60° alih-alih mengalikannya, padahal tinggi tidak mungkin melebihi panjang tangga.',
  ...
  },
  {
    ...
    pilihan: ['depan : samping', 'miring : depan', 'miring : samping', 'samping : miring', 'samping : depan'],
    benar: 4,
    langkah: [
      ...
      'Jadi, cot θ adalah perbandingan samping : depan. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, depan : samping, adalah tan θ, kebalikan dari yang ditanya. Pilihan B, miring : depan, adalah csc θ, dan pilihan C, miring : samping, adalah sec θ; keduanya kebalikan, tetapi dari fungsi yang lain.',
  ...
  },
  {
    ...
    pilihan: ['tiga kali lipat', 'sepertiganya', 'sembilan kali lipat', 'sama saja', 'tidak bisa ditentukan'],
    benar: 3,
    langkah: [
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai cos 180° adalah −1. (Jawaban D)',
    ],
  ...
  },
  {
    ...
    pilihan: ['0', '1', '0,5', '1,64', 'bergantung pada sudutnya'],
    benar: 1,
    langkah: [
      {
  ...
  },
  {
    ...
    pilihan: ['0,58', '0,42', '0,91', '0,84', 'tidak bisa ditentukan'],
    benar: 1,
    langkah: [
      ...
      'Jadi, nilai cos 65° = 0,42. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 0,58, mengurangkan 1 − 0,42, padahal sinus dan kosinus tidak berjumlah 1. Pilihan C, 0,91, adalah cos 25°, bukan cos 65°. Pilihan E menyerah, padahal sudut berpenyiku selalu bisa dihubungkan.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai tan 60° adalah √3. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, 1/√3, adalah tan 30°, karena sisi depan dan samping tertukar. Pilihan E, √3/2, adalah sin 60°; sisi miring ikut dipakai padahal tangen hanya memakai kedua kaki.',
  ...
  },
  {
    ...
    pilihan: ['(1/3)√7', '(3/7)√7', '3/4', '(4/7)√7', '(1/4)√7'],
    benar: 1,
    langkah: [
      ...
      'Jadi, nilai cot A = (3/7)√7. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, (1/3)√7, adalah tan A = √7/3, kebalikan dari yang ditanya. Pilihan C, 3/4, hanya mengulang nilai cos A. Pilihan E, (1/4)√7, adalah sin A = √7/4.',
  ...
  // ================================================================ SULIT
  {
    ...
    pilihan: ['0,75', '0,80', '1,25', '0,43', '0,60'],
    benar: 4,
    langkah: [
      ...
      'Jadi, nilai sin θ = 0,60. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, 0,75, hanya mengubah 3/4 ke desimal, seolah-olah sinus sama dengan tangen. Pilihan B, 0,80, adalah cos θ = 4/5. Pilihan C, 1,25, adalah sec θ = 5/4; pecahannya terbalik.',
  ...
  },
  {
    ...
    pilihan: ['1,73', '0,58', '-1,73', '-0,58', 'tidak terdefinisi'],
    benar: 2,
    langkah: [
      {
      ...
      'Jadi, nilai tan 120° ≈ −1,73. (Jawaban C)',
    ],
  ...
  },
  {
    ...
    pilihan: ['6,0 m', '20,8 m', '10,4 m', '13,9 m', '24,0 m'],
    benar: 1,
    langkah: [
      ...
      'Jadi, panjang bayangan tiang kira-kira 20,8 m. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 10,4 m, adalah 12 tan 30°, hasil mengalikan alih-alih membagi; padahal pada sudut 30° yang kecil, bayangan haruslah lebih panjang dari tiangnya. Pilihan E, 24,0 m, adalah panjang sinar (sisi miring, 12/sin 30°), bukan bayangannya.',
  ...
  },
  {
    ...
    pilihan: ['0° dan 180°', '45° dan 225°', '90° dan 270°', '180° saja', '90° saja'],
    benar: 2,
    langkah: [
      ...
      'Jadi, tan θ tidak terdefinisi pada 90° dan 270°. (Jawaban C)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai cos θ = −0,6. (Jawaban A)',
    ],
    jebakan: 'Pilihan B, 0,6, benar besarnya tetapi lupa memberi tanda kuadran II. Pilihan D, −0,2, mengurangkan 1 − 0,8, seolah sinus dan kosinus berjumlah 1; yang berjumlah 1 adalah kuadratnya.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai dari (5 sin x + 6 cos x)/(2 cos x − 3 sin x) adalah −4. (Jawaban D)',
    ],
    jebakan: 'Pilihan A, 4, lupa tanda negatif penyebut 2 − 6 = −4. Pilihan C, 16, hanya menghitung pembilangnya. Pilihan E, 11/8, mengganti sin x dan cos x keduanya dengan 1 lalu menambahkan tan x di tempat yang keliru.',
  ...
  },
  {
    ...
    pilihan: ['4 dan 360°', '3 dan 120°', '3 dan 360°', '4 dan 120°', '12 dan 120°'],
    benar: 3,
    langkah: [
      ...
      'Jadi, amplitudo dan periode grafik y = 4 cos(3x) berturut-turut 4 dan 120°. (Jawaban D)',
    ],
    jebakan: 'Pilihan B, 3 dan 120°, menukar peran kedua angka: 3 adalah pengali sudut yang menentukan periode, bukan amplitudo. Pilihan A, 4 dan 360°, lupa bahwa pengali 3 memperpendek periode. Pilihan E, 12, mengalikan 4 dan 3 tanpa alasan.',
  ...
  },
  {
    ...
    pilihan: ['16,9 m', '85,8 m', '18,7 m', '44,1 m', '94,6 m'],
    benar: 1,
    langkah: [
      ...
      'Jadi, jarak mendatar kapal dari kaki menara kira-kira 85,8 m. (Jawaban B)',
    ],
    jebakan: 'Pilihan C, 18,7 m, adalah 40 tan 25°, hasil mengalikan alih-alih membagi; padahal pada sudut sekecil 25° jaraknya harus jauh lebih panjang dari tinggi menara. Pilihan E, 94,6 m, adalah panjang garis pandang (40/sin 25°), yaitu sisi miring, bukan jarak mendatarnya.',
  ...
  },
  {
    ...
    pilihan: ['4 m', '1 m', '2 m', '6,28 m', '360 m'],
    benar: 0,
    langkah: [
      ...
      'Jadi, selisih antara titik tertinggi dan terendah adalah 4 m. (Jawaban A)',
    ],
    jebakan: 'Pilihan C, 2 m, hanya mengambil amplitudo (jarak dari sumbu ke puncak), padahal titik terendahnya di bawah sumbu, sehingga selisihnya dua kali amplitudo. Pilihan D, 6,28 m, mengira yang ditanya keliling roda (2π kali jari-jari 1).',
  ...
  },
  {
    ...
    pilihan: ['25 m', '43,3 m', '26 m', '44,3 m', '51 m'],
    benar: 2,
    langkah: [
      ...
      'Jadi, tinggi layang-layang dari tanah adalah 26 m. (Jawaban C)',
    ],
  ...
  },
  {
    ...
    pilihan: ['10,0 m', '11,5 m', '20,0 m', '17,3 m', '34,6 m'],
    benar: 3,
    langkah: [
      ...
      'Jadi, tinggi menara kira-kira 17,3 m. (Jawaban D)',
    ],
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai cos 110° · cot 160° + sin 200° = p − q. (Jawaban B)',
    ],
    jebakan: 'Pilihan A, p + q, lupa tanda negatif pada sin 200° (kuadran III). Pilihan E, 2p − 2q, muncul bila cot 160° dihitung sebagai −2p/q karena sudut 160° keliru diacukan ke 70° alih-alih 20°.',
  ...
  },
  {
    ...
    pilihan: ['4,8 cm', '6,4 cm', '6,0 cm', '8,0 cm', '3,6 cm'],
    benar: 1,
    langkah: [
      {
      ...
      'Jadi, panjang AD adalah 6,4 cm. (Jawaban B)',
    ],
  ...
  },
  {
    ...
    pilihan: ['34,6 m', '60,0 m', '103,9 m', '69,3 m', '138,6 m'],
    benar: 3,
    langkah: [
      ...
      'Jadi, jarak kedua mobil kira-kira 69,3 m. (Jawaban D)',
    ],
    jebakan: 'Pilihan C, 103,9 m, adalah jarak mobil 2 ke gedung, bukan jarak antar mobil. Pilihan A, 34,6 m, adalah jarak mobil 1 ke gedung. Pilihan E, 138,6 m, menjumlahkan kedua jarak, seolah-olah mobil berada di sisi gedung yang berlawanan.',
  ...
  },
  {
    ...
    pilihan: ['1/(1 + a²)', 'a/(1 + a²)', 'a²/(1 + a²)', 'a/√(1 + a²)', '1/a'],
    benar: 1,
    langkah: [
      ...
      'Jadi, nilai sin α · cos α = a/(1 + a²). (Jawaban B)',
    ],
    jebakan: 'Pilihan D, a/√(1 + a²), hanyalah cos α; perkalian dengan sin α membuat akarnya hilang. Pilihan C, a²/(1 + a²), adalah cos² α, dan pilihan A, 1/(1 + a²), adalah sin² α.',
  ...
  },
  {
    ...
    pilihan: ['2 sin θ cos θ', '(1/2) sin θ cos θ', 'sin² θ', 'cos² θ', 'sin θ cos θ'],
    benar: 4,
    langkah: [
      {
      ...
      'Jadi, luas segitiga OPQ adalah sin θ cos θ. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, 2 sin θ cos θ, lupa faktor 1/2 pada rumus luas segitiga. Pilihan B, (1/2) sin θ cos θ, memakai alas cos θ, padahal PQ membentang dari −cos θ sampai cos θ, sehingga panjangnya 2 cos θ.',
  ...
  },
  {
    ...
    langkah: [
      ...
      'Jadi, nilai sin θ = √3/2. (Jawaban E)',
    ],
    jebakan: 'Pilihan A, −√3/2, memberi tanda negatif pada sinus, padahal di kuadran II sinus positif; tanda negatif sekan hanya menandai kosinusnya. Pilihan B, −1/2, adalah cos θ. Pilihan D, 2, membaca sec θ seolah-olah nilai sinus.',
  ...
  },
  {
    ...
    pilihan: ['2 m', '12 m', '17 m', '22 m', '7 m'],
    benar: 4,
    langkah: [
      {
      ...
      'Jadi, tinggi kursi dari tanah saat θ = 210° adalah 7 m. (Jawaban E)',
    ],
    jebakan: 'Pilihan C, 17 m, lupa tanda negatif sin 210° sehingga kursi dianggap di atas poros. Pilihan A, 2 m, adalah titik terendah (θ = 270°, sin = −1), bukan pada 210°. Pilihan B, 12 m, mengira sinus 210° nol.',
  ...
  },
  {
    ...
    pilihan: ['0,923', '0,385', '0,417', '0,960', '2,400'],
    benar: 0,
    langkah: [
      ...
      'Jadi, nilai sin θ ≈ 0,923. (Jawaban A)',
    ],
    jebakan: 'Pilihan E, 2,400, adalah tan θ, bukan sin θ; ruas pada garis singgung memang tangen, dan sinus harus dihitung lagi dari segitiga acuannya. Pilihan B, 0,385, adalah cos θ = 5/13. Pilihan C, 0,417, adalah cot θ = 5/12.',
  ...
  },
  {
    ...
    pilihan: ['(sin θ, cos θ)', '(cos θ, -sin θ)', '(-cos θ, -sin θ)', '(-sin θ, cos θ)', '(sin θ, -cos θ)'],
    benar: 3,
    langkah: [
      {
      ...
      'Jadi, koordinat Q adalah (−sin θ, cos θ). (Jawaban D)',
    ],
    jebakan: 'Pilihan A, (sin θ, cos θ), hanya menukar koordinat tanpa memberi tanda negatif, padahal Q berada di kiri P. Pilihan E, (sin θ, −cos θ), adalah hasil putaran searah jarum jam (θ − 90°). Pilihan C adalah setengah putaran.',
  ...
  },
  {
    ...
    pilihan: ['0,48', '0,24', '0,40', '0,70', '0,96'],
    benar: 0,
    langkah: [
      ...
      'Jadi, nilai sin θ · cos θ = 0,48. (Jawaban A)',
    ],
