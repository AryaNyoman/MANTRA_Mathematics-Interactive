  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        simpul: 'Nilainya 49 per 2, yaitu 24,5, persis luas segitiga yang kita hitung di Materi 05. Ini Contoh Soal 3.7 di buku.',
      },
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
      ...
      },
      {
        ...
        simpul: 'Hasilnya 26 per 3, kira-kira 8,67. Ini Contoh Soal 3.9 di buku, dan didapat tanpa menumpuk satu persegi panjang pun.',
      },
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
      ...
      { jenis: 'paragraf', teks: 'Tidak semua soal serumit itu. Buku juga memberi contoh yang aman: kurva x dikali akar (x kuadrat tambah 5) di kuadran pertama, dibatasi sumbu x dan garis x sama dengan 2.' },
      {
        ...
        simpul: 'Kira-kira 5,27 satuan luas. Ini Contoh Soal 3.13 di buku. Langkah pertamanya bukan menghitung, melainkan memeriksa letak kurvanya.',
      },
