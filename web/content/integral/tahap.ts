  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Pasangkan sin x lebih dulu. Anda memilih cos x atau minus cos x? Perhatikan tanggapan alatnya.',
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Pilih fungsi x pada selang 0 sampai 7, dengan n sama dengan 7 dan titik sampel kanan. Bandingkan angka di panel dengan hitungan di atas.',
          ...
          'Ganti fungsinya menjadi 4 dikurangi x kuadrat, lalu ulangi. Apa yang berbeda dari percobaan pertama?',
        ],
      },
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Pilih kurva x pada selang 0 sampai 3. Baca nilai bagian kiri, bagian kanan, dan seluruhnya di panel.',
          ...
          'Ganti kurvanya menjadi x pangkat tiga dikurangi 4x pada selang -2 sampai 2. Berapa angka di panel, dan cocokkah dengan daerah berwarna yang Anda lihat?',
        ],
      },
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          ...
          'Ganti fungsinya menjadi 4 dikurangi x kuadrat. Saat kurva atas menurun mendekati nol, apa yang terjadi pada jejak di papan bawah?',
        ],
      },
  ...
  /* ================================================================= */
  {
    ...
    penjelasan: [
...

      {
        ...
        langkah: [
          'Pilih kurva x kuadrat dikurangi 4x, lalu tarik batas kiri ke 0 dan batas kanan ke 6.',
