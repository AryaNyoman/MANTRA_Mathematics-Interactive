...
import {
  GARIS_PETAK, GARIS_SUMBU, MAKS_HURUF_CATATAN, MONO, VH, VW, WARNA,
  keLayar, kotakUntuk, labelSkala, type Jendela,
...
/**
 * Bingkai koordinat yang dipakai bersama widget-widget Turunan.
 *
 * ASAL BERKAS INI sama dengan `koordinat.ts`: disalin dari wilayah sesi
 * Grafik Fungsi karena aturan melarang menyunting wilayah sesi lain.
 * Alasannya ditulis lengkap di kepala `koordinat.ts`.
 *
 ...
 *
 * `svgRef` dan penangan `pointer` dipakai widget yang titiknya bisa DISERET,
 * dan di topik ini hampir semuanya begitu: titik P, titik singgung, dan
 * pojok karton semuanya ditarik langsung dengan jari.
 *
