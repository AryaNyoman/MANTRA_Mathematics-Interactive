...
import { keMatematika, type Jendela } from '@/components/widget/turunan/koordinat'
 ...
 *
 * ASAL BERKAS INI
 * Disalin dari `widget/grafik-fungsi/seret.ts`, wilayah sesi lain yang tidak
 * boleh disunting. Isinya tidak diubah selain jalur impor; alasan salinannya
 * ditulis lengkap di kepala `koordinat.ts`.
 *
