...
/**
 * Pengganti sementara untuk widget Integral yang belum dibuat.
 *
 * Kerangka dari MATRA-MASTER, 6 Sep 2026. Tiap widget di rancangan
 * (docs/superpowers/specs/2026-09-06-integral-alur-belajar.md) diganti dengan
 * komponen sungguhan di folder ini, lalu pemanggilannya di
 * `components/topik/PanggungIntegral.tsx` diarahkan ke komponen itu. Setelah
