...
11. Susunan angka dan langkah: tiap besaran yang diketahui ditulis di BARIS SENDIRI ("Bayangan tiang: 6 m", baris baru "Tinggi Anda: 1,7 m"), dan tiap langkah perhitungan jadi satu butir daftar bernomor di baris sendiri, satu perhitungan per butir ("1. Perbandingan Anda: 1,7 ÷ 1,36 = 1,25", "2. Tinggi tiang: 6 × 1,25 = 7,5 m"). Jangan merangkai beberapa angka atau langkah dalam satu kalimat. Bentuk operasi mengikuti materi dan pertanyaan siswa: kalau materinya memakai pembagian biasa, pakai ÷; kalau memakai pecahan, tulis pecahannya dengan garis miring seperti 3/4 atau (x² + 1)/(x − 2), bukan ÷.`
