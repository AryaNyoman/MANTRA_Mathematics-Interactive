...
const KATA_PENUNTUN = /\b(diperoleh|sehingga|maka|adalah|misalkan|perhatikan|jadi|substitusi\w*|dengan|karena|ingat|diketahui|berarti|akibatnya|selanjutnya|tinjau|berlaku|menjadi|yaitu|artinya|didapat|terletak|memenuhi|berada|bernilai|merupakan|ambil|tulis\w*|uji|periksa|hitung|lengkapi|urutkan|susun|kalikan|bagi\w*|samakan|nyatakan|ubah|coret|kurangkan|tambahkan|jumlahkan|gunakan|terapkan|bandingkan|tentukan|cari|pilih|gambar\w*|tarik|proyeksi\w*|hasilnya|nilainya|tampak|haruslah|kita|ini|itu|tersebut|didefinisikan|definisi|pemeriksaan|sebagai|dinyatakan|disebut|memberi\w*|menghasilkan|terbukti|secara umum|dikatakan|panjang\w*|luas\w*|besar\w*|bila|jika|selalu|sama dengan|memakai|dipakai|ketika|saat|menuju|mendekati|membesar|menyusut)\b/i
